...
<petclinic:layout pageName="editVivienda">
	...
	<jsp:body>
        ...
        <form:form modelAttribute="vivienda" class="form-horizontal"
			action="/viviendas/save">
            <div class="form-group has-feedback">
                <petclinic:inputField label="Título" name="titulo" />
                <petclinic:inputField label="Fecha de publicacion"
					name="fechaPublicacion" />
                <petclinic:inputField label="DirecciÃ³n"
					name="direccion" />
                <petclinic:inputField label="Zona" name="zona" />
                <petclinic:inputField label="Precio" name="precio" />
                <petclinic:inputField label="Dimensiones"
					name="dimensiones" />
                ...
                <petclinic:inputField label="Caracteristicas"
					name="caracteristicas" />
                <petclinic:inputField label="Equipamiento"
					name="equipamiento" />
                <petclinic:inputField label="Horario de Visita"
					name="horarioVisita" />
